...
export default function Calendar() {
    ...
    }, [maintenanceForm.property_id, rooms]);
    ...
    const handleMaintenanceSubmit = async (e) => {
        ...
        const formData = {
            ...
            end_date: maintenanceForm.end_date || null,
        };
        ...
        try {
            ...
            const data = {
                ...
                urgency_type: maintenanceForm.urgency_type?.value || null,
                maintenance_type: maintenanceForm.maintenance_type?.value || null,
                report_date: maintenanceForm.report_date || null,
                start_date: maintenanceForm.start_date || null,
                end_date: maintenanceForm.end_date || null,
    ...
    const handleCheckinSubmit = async (e) => {
        ...
        // Prepare data for validation
        const formData = {
            checkin_date: checkinForm.checkin_date || null,
    ...
    const handleCheckoutSubmit = async (e) => {
        ...
        // Prepare data for validation
        const formData = {
            checkout_date: checkoutForm.checkout_date || null,
        ...
        <div>
            ...
            >
                <form onSubmit={handleReportSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <FormField label="Seleziona immobile">
                            <Select
                                options={properties}
                        ...
                        <FormField label="Seleziona stanza">
                            <Select
                                options={filteredRooms}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-center">
                            <p className="text-xl font-semibold text-gray-800">
                                {selectedEvent.type === 'maintenance'
                                    ? selectedEvent.data.maintenance_name
                                    : selectedEvent.type === 'checkin'
                                    ? selectedEvent.data.location
                                    : selectedEvent.type === 'checkout'
                                    ? selectedEvent.data.location
                                    : selectedEvent.data.activity_name}
                            </p>
                        </div>
