...
const MMBrand = ({textWhite = false, showTech = true}) => {
    ...
    const logoUrl = "https://michelemincone.com/wp-content/uploads/2025/10/michelemincone_new_logo_alphachannel.png";
    ...
    const Logo = () => (
        <img src={logoUrl} alt="Michele Mincone Logo" className="h-6 mx-auto mb-2" style={{height: 40}} />
    );
